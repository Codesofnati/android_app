...
public class GridviewAdapterTriceps extends ArrayAdapter<DandFModel> {
    public GridviewAdapterTriceps(@NonNull Context context, ArrayList<DandFModel> DandFModel) {
