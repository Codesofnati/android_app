...
public class GridviewAdapterBiceps extends ArrayAdapter<DandFModel> {
    public GridviewAdapterBiceps(@NonNull Context context, ArrayList<DandFModel> DandFModel) {
